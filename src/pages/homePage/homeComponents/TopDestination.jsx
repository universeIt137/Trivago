                    ...
                    <div className=' rounded-lg '>
                        ...
                        <div className='flex justify-between rounded-b-2xl items-center mt-2 bg-white shadow-lg p-3'>
                            ...
                            <p>Machu,Pichu,Peru</p>
                             <p className='text-l'><span className='text-xl'>$300</span>  x 12 interest free</p>

                            </div>
                            <div className='text-right rounded-lg'> 

                            <button className='bg-blue-500 hover:bg-blue-400 text-white text-sm py-2 px-4 rounded-full mt-2'>See More</button>
                            </div>
                        </div>
